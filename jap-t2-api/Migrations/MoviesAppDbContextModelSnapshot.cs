            ...
            modelBuilder.Entity("JAP_Task_1_MoviesApi.Models.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2021, 9, 23, 14, 26, 54, 83, DateTimeKind.Local).AddTicks(7194),
                            FirstName = "Admin",
                            LastName = "Admin",
                            PasswordHash = new byte[] { 155, 242, 1, 191, 252, 164, 250, 99, 27, 26, 216, 234, 202, 177, 197, 230, 233, 79, 205, 116, 11, 70, 160, 137, 212, 109, 175, 114, 27, 240, 44, 209, 89, 52, 239, 170, 233, 163, 185, 69, 23, 41, 4, 12, 72, 181, 224, 63, 116, 175, 160, 135, 107, 241, 252, 21, 138, 23, 10, 45, 151, 5, 0, 40 },
                            PasswordSalt = new byte[] { 116, 151, 216, 45, 150, 232, 11, 202, 39, 97, 202, 100, 29, 246, 87, 39, 169, 3, 230, 182, 248, 114, 119, 21, 175, 148, 212, 75, 85, 163, 100, 0, 129, 140, 219, 145, 137, 170, 2, 45, 167, 160, 5, 253, 206, 119, 247, 112, 228, 29, 91, 85, 37, 228, 204, 127, 244, 224, 171, 53, 112, 159, 138, 30, 171, 209, 31, 3, 232, 201, 140, 221, 140, 189, 197, 1, 179, 8, 187, 46, 72, 45, 86, 130, 218, 16, 212, 74, 176, 66, 141, 40, 26, 54, 194, 125, 0, 233, 157, 102, 136, 48, 132, 132, 147, 135, 179, 99, 224, 227, 36, 216, 186, 250, 209, 218, 135, 149, 194, 123, 193, 219, 24, 6, 136, 64, 97, 111 },
                            Username = "admin"
                        });
                });
