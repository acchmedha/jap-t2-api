...
namespace MoviesApp.Api.Migrations
{
    ...
    [Migration("20210925203553_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MoviesApp.Api.Entities.TicketEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("ScreeningEntityId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MoviesApp.Api.Entities.TicketEntity", b =>
                {
                    b.HasOne("MoviesApp.Api.Entities.ScreeningEntity", null)
                        .WithMany("Tickets")
                        .HasForeignKey("ScreeningEntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
